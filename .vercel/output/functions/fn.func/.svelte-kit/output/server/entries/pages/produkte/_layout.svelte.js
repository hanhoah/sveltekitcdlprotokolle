...
const Hashtags = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let topHashTags = [];
  return `<div class="bg-red-200 mt-10 p-3"><h2 data-svelte-h="svelte-1dglh44">Nicht das passende Produkt gefunden? Wähle einen der folgenden beliebten Hashtags:</h2> <div class="col columns-3 md:columns-6 text-xs">${each(topHashTags, ({ tag, anzahl, hashtag_id }) => {
